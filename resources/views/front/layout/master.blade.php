                ...
                <div class="inner-header">
                    <div class="row">
                        <div class="col-lg-2 col-md-2">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="/front/front/img/logo.png" height="25" alt="">
                                </a>
                            </div>
                        </div>
                                    ...
                                    <div class="cart-hover">
                                        <div class="select-items">
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td class="si-pic"><img src="/front/front/img/select-product-1.jpg" alt=""></td>
                                                        <td class="si-text">
                                                    ...
                                                    <tr>
                                                        <td class="si-pic"><img src="/front/front/img/select-product-2.jpg" alt=""></td>
                                                        <td class="si-text">
                                                            <div class="product-selected">
                                                                <p>$60.00 x 1</p>
                                                                <h6>Kabino Bedside Table</h6>
                        ...
                        <ul>
                            ...
                            <li><a href="">Pages</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="check-out.html">Checout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="footer-left">
                            ...
                            <ul>
                                <li>Quoc Oai Ha Noi</li>
                                <li>Phone: 0978660288</li>
                                <li>Email: pn463187@gmail.com</li>
                            </ul>
